        ...
        for (int i = 0; i < count; i++) {
            ...
            if (currentAngle <= 30 || currentAngle > 330) {
                left = (int) (mCenterX + mRadius * Math.tan(mAngle * Math.PI / 180f)
                        * Math.sin(60 * Math.PI / 180f) - childH / 2);
                top = (int) (mCenterY - mRadius * Math.sin(60 * Math.PI / 180f) - childH / 2);
            }
            if (currentAngle > 30 && currentAngle <= 90) {
                left = (int) (mCenterX + mRadius * Math.tan(mAngle * Math.PI / 180f)
                        / (Math.tan(30 * Math.PI / 180f) + Math.tan(mAngle * Math.PI / 180f)) - childW / 2);
                top = (int) (mCenterY - mRadius
                        / (Math.tan(30 * Math.PI / 180f) + Math.tan(mAngle * Math.PI / 180f)) - childH / 2);
            }
            if (currentAngle > 90 && currentAngle <= 150) {
                left = (int) (mCenterX - mRadius * Math.tan(mAngle * Math.PI / 180f)
                        / (Math.tan(30 * Math.PI / 180f) - Math.tan(mAngle * Math.PI / 180f)) - childW / 2);
                top = (int) (mCenterY + mRadius
                        / (Math.tan(30 * Math.PI / 180f) - Math.tan(mAngle * Math.PI / 180f)) - childH / 2);
            ...
            if (currentAngle > 210 && currentAngle <= 270) {
                left = (int) (mCenterX - mRadius * Math.tan(mAngle * Math.PI / 180f)
                        / (Math.tan(30 * Math.PI / 180f) + Math.tan(mAngle * Math.PI / 180f)) - childW / 2);
                top = (int) (mCenterY + mRadius
                        / (Math.tan(30 * Math.PI / 180f) + Math.tan(mAngle * Math.PI / 180f)) - childH / 2);
            }
            if (currentAngle > 270 && currentAngle <= 330) {
                left = (int) (mCenterX + mRadius * Math.tan(mAngle * Math.PI / 180f)
                        / (Math.tan(30 * Math.PI / 180f) - Math.tan(mAngle * Math.PI / 180f)) - childW / 2);
                top = (int) (mCenterY - mRadius
                        / (Math.tan(30 * Math.PI / 180f) - Math.tan(mAngle * Math.PI / 180f)) - childH / 2);
            ...
            // 放大 缩小
            if (currentAngle1 > -sPerAngle / 2 && currentAngle1 < sPerAngle / 2) {

                float per = (float) Math.abs(currentAngle1 * 2) / sPerAngle;
